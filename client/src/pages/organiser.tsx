  ...
  useEffect(() => {
    const fetchDetails = async () => {
      if (getOrganizationByAddress) {
        ...
        if (res == undefined) {
          router.push(`/requestOrganiser`);
          toast.error("Please register as an organisation first");
          return;
        }
              ...
              <Formik
                ...
                onSubmit={(values, _) => {
                  ...
                  if (createEvent) {
                    ...
                    ); // Add 5 days in milliseconds
                    const timestamp = Math.floor(
                      fiveDaysLater.getTime() / 1000
                    );
